...
*   **Digital Identity Verification System:** Designing a secure credential ecosystem leveraging RSA cryptography, cross-language compilation, and microservices architecture.
*   **AI-Driven Predictive Scaling Engine:** Developing an automated infrastructure pipeline that utilizes machine learning models to forecast server traffic and provision AWS EC2 resources via Terraform.
*   **IoT Security & Auditing:** Researching vulnerabilities in smart appliance firmware and building centralized telemetry intake dashboards using FastAPI and MongoDB.
